...
- **🐛 La Chenille** (snake tout doux : les bords téléportent, se marcher dessus fait juste trébucher), **🎪 Chamboule-Tout** (balle qui se balade, pyramide de boîtes-animaux qui dégringolent en cascade, la vache fait meuh), **🎆 Feu d'Artifice** (tape le ciel : sifflement, explosion en boule/anneau/cœur/étoile, bouquet final) — zéro échec
