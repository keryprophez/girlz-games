...
- **🌾 La Ferme Vivante** : l'accueil n'est plus une grille de cartes, c'est un **monde**. Les deux filles s'y promènent (leurs photos en avatar), le **ciel suit l'heure réelle** (matin, jour, soir, nuit étoilée avec la lune), et chaque étoile gagnée **construit quelque chose de visible** : pommier (10⭐), mare aux canards (25⭐), moulin qui tourne (50⭐), serre à fleurs (80⭐), montgolfière (120⭐), arc-en-ciel (175⭐), château (250⭐). Les animaux de l'album gambadent dans le pré. On touche **L'École 🧠, La Grange 🎯, Le Pré ⚡ ou L'Atelier 🎨** pour ouvrir ses jeux — et une barre montre la prochaine construction. Bouton 📋 pour revenir à la liste classique
